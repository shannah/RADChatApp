 ...
 *  @author shannah
 */
public class ChatRoomView extends <any> {

	public static final Category TEXT_ACTIONS;

	/**
	 *  Category used to register an action to be fired when the user hits "send".
	 */
	public static final Category SEND_ACTION;
	 ...
	 *  @param entity 
	 */
	public ChatRoomView(Entity entity, Form form) {
	}
	 ...
	 */
	public ChatRoomView(Entity entity, Node node, Form form) {
	}
	...
	public static class ViewModel {
		 ...
		 *  @return 
		 */
		public ChatRoomView.ViewModel removeMessages(Entity[] entities) {
		}
		 ...
		 *  @return 
		 */
		public ChatRoomView.ViewModel addParticipants(Entity[] entities) {
		}
