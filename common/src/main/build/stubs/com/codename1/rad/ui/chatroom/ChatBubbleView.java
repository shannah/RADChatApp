 ...
 *  @author shannah
 */
public class ChatBubbleView extends <any> {

	/**
	 *  Actions displayed in popup menu when user long presses a chat bubble.
	 */
	public static final Category CHAT_BUBBLE_LONG_PRESS_MENU;

	/**
	 *  Actions displayed in popup menu when user clicks chat bubble.
	 */
	public static final Category CHAT_BUBBLE_CLICKED_MENU;

	/**
	 *  Action fired when user clicks chat bubble.
	 */
	public static final Category CHAT_BUBBLE_CLICKED;

	/**
	 *  Action fired when user longpresses chat bubble.
	 */
	public static final Category CHAT_BUBBLE_LONG_PRESS;

	/**
	 *  Actions displayed as "badges" of a chat bubble.
	 */
	public static final Category CHAT_BUBBLE_BADGES;
	 ...
	 */
	public static final <any> USE_OVERFLOW_CONTAINER;
	 ...
	 */
	public ChatBubbleView(Entity entity, Node viewNode) {
	}
