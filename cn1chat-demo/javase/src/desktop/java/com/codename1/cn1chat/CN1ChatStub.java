 ...
 * @author Shai Almog
 */
public class CN1ChatStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "CN1Chat";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new CN1ChatStub());
    }
